...
import {fetchLocationMedia, type LocationMedia, normalSearchText} from './PPX';
import './Desc.css';
...
export default function Desc(props: DescProps): React.ReactElement {
    ...
    const fetchMedia = useCallback(async (targetCity: string, externalCtrl?: AbortController) => {
        const ctrl = externalCtrl ?? new AbortController();
