...
const Timeline = forwardRef<TimelineHandle, TimelineProps>(
  ({ events: initialEvents = [], onEventClick, className = "" }, ref) => {
    ...
    useEffect(() => {
      setEvents((prev) => {
        ...
        const newEvents = initialEvents.filter(
    ...
    useEffect(() => {
      ...
      const eventElements =
        timelineRef.current.querySelectorAll(".timeline-event");
            ...
            return (
              ...
              >
                <div
                  ...
                  aria-hidden={!dateParts.yearLabel && !dateParts.shortLabel}
                >
                  {dateParts.yearLabel && (
                    <span className="timeline-event__time-year">
                      {dateParts.yearLabel}
                    </span>
                  )}
                  <time
